                ...
                <div className="modal-dialog">
                    ...
                    <div className="flex flex-col gap-2">
                        <span className="text-base font-medium text-darkbtn dark:text-white flex items-center gap-1">
                            <RiGlobalLine className='text-lg' /> {domainName || t.admin.yourDomain || "yourdomain.com"}
                        </span>
                        ...
                        <div className='flex flex-col gap-1 w-full'>
                            ...
                            {availablePlans.map((plan) => {
                                ...
                                return (
                                    <label
                                        key={plan.id}
                                        className={`choose-plan-price flex-col gap-2.5 ${isSelected ? "selected" : ""
                                            }`}
                                    >
                                        <div className="flex justify-between items-start w-full">
                                            ...
                                            <p className="text-13 font-medium text-secondary">
                                                {plan.description || (plan.id === "full" ? t.admin.fullPrivacyDescription : 
                                                 plan.id === "limited" ? t.admin.limitedPrivacyDescription : 
                    ...
                    <div className='order-summary w-full mt-5'>
                        ...
                        <div className="flex gap-5 flex-col w-full">
                            <div>
                                ...
                                <div className='flex justify-between items-center mb-1.5 text-13 text-primary dark:text-gray-500 font-medium'>
                                    <p className='flex gap-1 items-center'>{t.admin.vat20Percent} <FiInfo /></p>
                                    <span>{currencyFormatter.format(vatAmount)}</span>
                                </div>
                                <div className='flex justify-between items-center mb-1.5 text-13 text-primary dark:text-gray-500 font-medium'>
                                    <p className='flex gap-1 items-center'>{t.admin.expiration} <FiInfo /></p>
                                ...
                                <div className='flex justify-between items-center'>
                                    <p className='text-primary dark:text-gray-500 text-15 font-medium'>{t.admin.total}:</p>
                            ...
                            <div className="flex flex-col gap-2">
                                <p className="flex items-center gap-2 text-13 text-darkbtn hover:text-darkbtn-hover dark:text-gray-500 hover:dark:text-white font-medium cursor-pointer">{t.cart.orderSummary.havePromocode} <IoChevronDown size={14} /></p>
                                ...
                                <div className='flex justify-start my-2'>
                                    <button
                                        ...
                                        disabled={isProcessing || isCheckoutLoading || !onCheckout || !selectedPlan || selectedPlan.price <= 0}
                                    >
                                        {isProcessing || isCheckoutLoading
                                            ? t.admin.processing
                                            : t.admin.goToCheckout}
                                        {!(isProcessing || isCheckoutLoading) && <TbArrowRight size={18} />}
                                    </button>
                                </div>
